...
# Hierarchical cell: picoAxiProcessor
proc create_hier_cell_picoAxiProcessor { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_picoAxiProcessor() - Empty argument(s)!"}
     return
  }
 ...
 ] [get_bd_intf_pins /picoAxiProcessor/picorv32/mem_axi]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: picoAxiProcessor
  create_hier_cell_picoAxiProcessor [current_bd_instance .] picoAxiProcessor
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net M_AXI_RISCV [get_bd_intf_pins picoAxiProcessor/M_AXI_RISCV] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  connect_bd_intf_net -intf_net S_AXI_MEM [get_bd_intf_pins picoAxiProcessor/S_AXI_MEM] [get_bd_intf_pins psAxiInterconnect/M02_AXI]
  ...
  connect_bd_net -net por_resetn [get_bd_pins picoAxiProcessor/por_resetn] [get_bd_pins porReset/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  ...
  connect_bd_net -net subprocessorClk [get_bd_pins picoAxiProcessor/riscv_clk] [get_bd_pins subprocessorClk/clk_out1]
  connect_bd_net -net riscv_resetn [get_bd_pins picoAxiProcessor/riscv_resetn] [get_bd_pins resetSlice/Dout]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins irqConcat/dout] [get_bd_pins psInterruptController/intr]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x40010000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs picoAxiProcessor/psBramController/S_AXI/Mem0] SEG_psBramController_Mem0
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x00000000 [get_bd_addr_spaces picoAxiProcessor/picorv32/mem_axi] [get_bd_addr_segs picoAxiProcessor/riscvBramController/S_AXI/Mem0] SEG_picorv32BramController_Mem0
  create_bd_addr_seg -range 0x10000000 -offset 0x10000000 [get_bd_addr_spaces picoAxiProcessor/picorv32/mem_axi] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
...
proc available_tcl_procs { } {
   ...
   puts "#"
   puts "#    create_hier_cell_picoAxiProcessor parentCell nameHier"
