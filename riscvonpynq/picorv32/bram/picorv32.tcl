...
################################################################
# This is a generated script based on design: picorv32
#
...
drichmond:ip:PicoBramBridge:1.0\
"
...
# Hierarchical cell: picoBramProcessor
proc create_hier_cell_picoBramProcessor { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_picoBramProcessor() - Empty argument(s)!"}
     return
  }
  ...
  set picorv32 [ create_bd_cell -type ip -vlnv cliffordwolf:ip:picorv32_bram:1.0 picorv32 ]
  ...
  # Create instance: riscvBramBridge, and set properties
  set riscvBramBridge [ create_bd_cell -type ip -vlnv drichmond:ip:PicoBramBridge:1.0 riscvBramBridge ]
  ...
  connect_bd_intf_net -intf_net picoBramInterface [get_bd_intf_pins picorv32/M_PBRAM_MEM] [get_bd_intf_pins riscvBramBridge/S_PICOBRAM_MEM]
  ...
  connect_bd_intf_net -intf_net riscvBramBridge [get_bd_intf_pins riscvBram/BRAM_PORTA] [get_bd_intf_pins riscvBramBridge/BRAM]
  ...
  connect_bd_net -net picorv32_bram_0_trap [get_bd_pins irq] [get_bd_pins picorv32/trap]
  connect_bd_net -net riscvReset_peripheral_aresetn [get_bd_pins picorv32/resetn] [get_bd_pins riscvBramBridge/RSTN] [get_bd_pins riscvReset/peripheral_aresetn]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins psBramController/s_axi_aresetn]
  connect_bd_net -net subprocessorClk [get_bd_pins riscv_clk] [get_bd_pins picorv32/clk] [get_bd_pins riscvBramBridge/CLK] [get_bd_pins riscvReset/slowest_sync_clk]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: picoBramProcessor
  create_hier_cell_picoBramProcessor [current_bd_instance .] picoBramProcessor
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI_MEM [get_bd_intf_pins picoBramProcessor/S_AXI_MEM] [get_bd_intf_pins psAxiInterconnect/M02_AXI]
  ...
  # Create port connections
  connect_bd_net -net FCLK_CLK0 [get_bd_pins picoBramProcessor/s_axi_aclk] [get_bd_pins porReset/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins psAxiInterconnect/ACLK] [get_bd_pins psAxiInterconnect/M00_ACLK] [get_bd_pins psAxiInterconnect/M01_ACLK] [get_bd_pins psAxiInterconnect/M02_ACLK] [get_bd_pins psAxiInterconnect/S00_ACLK] [get_bd_pins psInterruptController/s_axi_aclk] [get_bd_pins subprocessorClk/clk_in1] [get_bd_pins subprocessorClk/s_axi_aclk]
  connect_bd_net -net FCLK_CLK1 [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK]
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins picoBramProcessor/s_axi_aresetn] [get_bd_pins porReset/peripheral_aresetn] [get_bd_pins psAxiInterconnect/M00_ARESETN] [get_bd_pins psAxiInterconnect/M01_ARESETN] [get_bd_pins psAxiInterconnect/M02_ARESETN] [get_bd_pins psAxiInterconnect/S00_ARESETN] [get_bd_pins psInterruptController/s_axi_aresetn] [get_bd_pins subprocessorClk/s_axi_aresetn]
  connect_bd_net -net irq [get_bd_pins irqConcat/In0] [get_bd_pins picoBramProcessor/irq]
  ...
  connect_bd_net -net por_resetn [get_bd_pins picoBramProcessor/por_resetn] [get_bd_pins porReset/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  ...
  connect_bd_net -net riscv_resetn [get_bd_pins picoBramProcessor/riscv_resetn] [get_bd_pins resetSlice/Dout]
  connect_bd_net -net subprocessorClk [get_bd_pins picoBramProcessor/riscv_clk] [get_bd_pins subprocessorClk/clk_out1]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins irqConcat/dout] [get_bd_pins psInterruptController/intr]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x40010000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs picoBramProcessor/psBramController/S_AXI/Mem0] SEG_psBramController_Mem0
...
proc available_tcl_procs { } {
   ...
   puts "#"
   puts "#    create_hier_cell_picoBramProcessor parentCell nameHier"
