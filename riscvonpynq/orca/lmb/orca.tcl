...
################################################################
# This is a generated script based on design: orca
#
...
proc create_hier_cell_orcaLmbProcessor { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir O -from 0 -to 0 irq
  ...
  # Create instance: riscvIrqGpio, and set properties
  set riscvIrqGpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 riscvIrqGpio ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net orca_DUC [get_bd_intf_pins orca/DUC] [get_bd_intf_pins riscvIrqGpio/S_AXI]
  ...
  connect_bd_net -net riscvIrqGpio_gpio_io_o [get_bd_pins irq] [get_bd_pins riscvIrqGpio/gpio_io_o]
  connect_bd_net -net riscvReset_peripheral_aresetn [get_bd_pins riscvIrqGpio/s_axi_aresetn] [get_bd_pins riscvReset/peripheral_aresetn]
  ...
  connect_bd_net -net subprocessorClk [get_bd_pins riscv_clk] [get_bd_pins orca/clk] [get_bd_pins riscvIrqGpio/s_axi_aclk] [get_bd_pins riscvLmbCtrl/LMB_Clk] [get_bd_pins riscvReset/slowest_sync_clk]
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI_MEM [get_bd_intf_pins orcaLmbProcessor/S_AXI_MEM] [get_bd_intf_pins psAxiInterconnect/M02_AXI]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x10000000 [get_bd_addr_spaces orcaLmbProcessor/orca/DUC] [get_bd_addr_segs orcaLmbProcessor/riscvIrqGpio/S_AXI/Reg] SEG_riscvIrqGpio_Reg
