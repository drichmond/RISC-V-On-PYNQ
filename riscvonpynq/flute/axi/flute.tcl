...
bluespec.com:ip:flute_RV32IMU:1.0\
...
# Hierarchical cell: fluteAxiProcessor
proc create_hier_cell_fluteAxiProcessor { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_fluteAxiProcessor() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: flute, and set properties
  set flute [ create_bd_cell -type ip -vlnv bluespec.com:ip:flute_RV32IMU:1.0 flute ]
 ...
 ] [get_bd_intf_pins /fluteAxiProcessor/flute/M_AXI_DMEM]
  ...
  set_property -dict [ list \
   ...
   CONFIG.NUM_WRITE_OUTSTANDING {2} \
   CONFIG.MAX_BURST_LENGTH {256} \
 ] [get_bd_intf_pins /fluteAxiProcessor/flute/M_AXI_IMEM]
  ...
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins flute/M_AXI_DMEM]
  ...
  connect_bd_intf_net -intf_net flute_M_AXI_IMEM [get_bd_intf_pins axi_interconnect_0/S01_AXI] [get_bd_intf_pins flute/M_AXI_IMEM]
  ...
  connect_bd_net -net riscvReset_peripheral_aresetn [get_bd_pins m_axi_dmem_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins flute/RST_N] [get_bd_pins procBramController/s_axi_aresetn]  [get_bd_pins riscvReset/peripheral_aresetn]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins psBramController/s_axi_aresetn]
  connect_bd_net -net subprocessorClk [get_bd_pins m_axi_dmem_aclk] [get_bd_pins riscv_clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins flute/CLK] [get_bd_pins procBramController/s_axi_aclk] [get_bd_pins riscvReset/slowest_sync_clk]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: fluteAxiProcessor
  create_hier_cell_fluteAxiProcessor [current_bd_instance .] fluteAxiProcessor
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S01_AXI_1 [get_bd_intf_pins irqAxiInterconnect/S01_AXI] [get_bd_intf_pins fluteAxiProcessor/M_AXI_DMEM]
  connect_bd_intf_net -intf_net S_AXI_MEM_1 [get_bd_intf_pins fluteAxiProcessor/S_AXI_MEM] [get_bd_intf_pins psAxiInterconnect/M01_AXI]
  ...
  # Create port connections
  connect_bd_net -net FCLK_CLK0 [get_bd_pins irqAxiInterconnect/ACLK] [get_bd_pins irqAxiInterconnect/M00_ACLK] [get_bd_pins irqAxiInterconnect/S00_ACLK] [get_bd_pins fluteAxiProcessor/s_axi_aclk] [get_bd_pins porReset/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins psAxiInterconnect/ACLK] [get_bd_pins psAxiInterconnect/M00_ACLK] [get_bd_pins psAxiInterconnect/M01_ACLK] [get_bd_pins psAxiInterconnect/S00_ACLK] [get_bd_pins psInterruptController/s_axi_aclk] [get_bd_pins subprocessorClk/clk_in1] [get_bd_pins subprocessorClk/s_axi_aclk]
  connect_bd_net -net FCLK_CLK1 [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK]
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins irqAxiInterconnect/M00_ARESETN] [get_bd_pins irqAxiInterconnect/S00_ARESETN] [get_bd_pins fluteAxiProcessor/s_axi_aresetn] [get_bd_pins porReset/peripheral_aresetn] [get_bd_pins psAxiInterconnect/M00_ARESETN] [get_bd_pins psAxiInterconnect/M01_ARESETN] [get_bd_pins psAxiInterconnect/S00_ARESETN] [get_bd_pins psInterruptController/s_axi_aresetn] [get_bd_pins subprocessorClk/s_axi_aresetn]
  connect_bd_net -net orcaLmbProcessor_irq [get_bd_pins irqConcat/In0] [get_bd_pins fluteAxiProcessor/irq]
  connect_bd_net -net orcaLmbProcessor_m_axi_duc_aclk [get_bd_pins irqAxiInterconnect/S01_ACLK] [get_bd_pins fluteAxiProcessor/m_axi_dmem_aclk]
  connect_bd_net -net orcaLmbProcessor_m_axi_duc_aresetn [get_bd_pins irqAxiInterconnect/S01_ARESETN] [get_bd_pins fluteAxiProcessor/m_axi_dmem_aresetn]
  ...
  connect_bd_net -net por_resetn [get_bd_pins fluteAxiProcessor/por_resetn] [get_bd_pins porReset/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  ...
  connect_bd_net -net riscv_resetn [get_bd_pins fluteAxiProcessor/riscv_resetn] [get_bd_pins resetSlice/Dout]
  connect_bd_net -net subprocessorClk [get_bd_pins fluteAxiProcessor/riscv_clk] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins subprocessorClk/clk_out1]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins irqConcat/dout] [get_bd_pins psInterruptController/intr]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x40010000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs fluteAxiProcessor/psBramController/S_AXI/Mem0] SEG_psBramController_Mem0
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x00000000 [get_bd_addr_spaces fluteAxiProcessor/flute/M_AXI_DMEM] [get_bd_addr_segs fluteAxiProcessor/procBramController/S_AXI/Mem0] SEG_procBramController_Mem0
  create_bd_addr_seg -range 0x00010000 -offset 0x00000000 [get_bd_addr_spaces fluteAxiProcessor/flute/M_AXI_IMEM] [get_bd_addr_segs fluteAxiProcessor/procBramController/S_AXI/Mem0] SEG_procBramController_Mem0
  create_bd_addr_seg -range 0x00001000 -offset 0x80000000 [get_bd_addr_spaces fluteAxiProcessor/flute/M_AXI_DMEM] [get_bd_addr_segs psInterruptController/S_AXI/Reg] SEG_psInterruptController_Reg

  # Exclude Address Segments
  create_bd_addr_seg -range 0x00001000 -offset 0x80000000 [get_bd_addr_spaces fluteAxiProcessor/flute/M_AXI_IMEM] [get_bd_addr_segs psInterruptController/S_AXI/Reg] SEG_psInterruptController_Reg
  exclude_bd_addr_seg [get_bd_addr_segs fluteAxiProcessor/flute/M_AXI_IMEM/SEG_psInterruptController_Reg]
...
proc available_tcl_procs { } {
   ...
   puts "#"
   puts "#    create_hier_cell_fluteAxiProcessor parentCell nameHier"
