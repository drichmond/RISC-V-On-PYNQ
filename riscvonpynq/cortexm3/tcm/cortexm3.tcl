...
proc create_hier_cell_processor { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net cortexm3_CM3_SYS_AXI3 [get_bd_intf_pins cortexm3/CM3_SYS_AXI3] [get_bd_intf_pins spAxiInterconnect/S00_AXI]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x80000000 [get_bd_addr_spaces processor/cortexm3/CM3_SYS_AXI3] [get_bd_addr_segs psInterruptController/S_AXI/Reg] SEG_psInterruptController_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x80000000 [get_bd_addr_spaces processor/cortexm3/CM3_CODE_AXI3] [get_bd_addr_segs psInterruptController/S_AXI/Reg] SEG_psInterruptController_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x00000000 [get_bd_addr_spaces processor/cortexm3/CM3_SYS_AXI3] [get_bd_addr_segs processor/spBramController/S_AXI/Mem0] SEG_spBramController_Mem0
  create_bd_addr_seg -range 0x00010000 -offset 0x00000000 [get_bd_addr_spaces processor/cortexm3/CM3_CODE_AXI3] [get_bd_addr_segs processor/spBramController/S_AXI/Mem0] SEG_spBramController_Mem0
