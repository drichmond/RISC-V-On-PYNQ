...
//
// On Thu Mar  7 13:49:58 PST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkSoC_Map(CLK,
  ...
  // value method m_uart0_addr_base
  assign m_uart0_addr_base = 64'h00000000F0000000 ;

  // value method m_uart0_addr_size
  assign m_uart0_addr_size = 64'h0 ;

  // value method m_uart0_addr_lim
  assign m_uart0_addr_lim = 64'h00000000F0000000 ;

  // value method m_near_mem_io_addr_base
  assign m_near_mem_io_addr_base = 64'h0000000080000000 ;

  // value method m_near_mem_io_addr_size
  assign m_near_mem_io_addr_size = 64'h0000000000010000 ;

  // value method m_near_mem_io_addr_lim
  assign m_near_mem_io_addr_lim = 64'h0000000080010000 ;

  // value method m_boot_rom_addr_base
  assign m_boot_rom_addr_base = 64'h0 ;

  // value method m_boot_rom_addr_size
  assign m_boot_rom_addr_size = 64'h0 ;

  // value method m_boot_rom_addr_lim
  assign m_boot_rom_addr_lim = 64'd0 ;

  // value method m_mem0_controller_addr_base
  assign m_mem0_controller_addr_base = 64'h0 ;

  // value method m_mem0_controller_addr_size
  assign m_mem0_controller_addr_size = 64'h000000000FFFFFFF ;

  // value method m_mem0_controller_addr_lim
  assign m_mem0_controller_addr_lim = 64'd268435455 ;
  ...
  // value method m_is_mem_addr
  assign m_is_mem_addr = m_is_mem_addr_addr < 64'd268435455 ;

  // value method m_is_IO_addr
  assign m_is_IO_addr =
	     m_is_IO_addr_addr >= 64'h0000000080000000 &&
	     m_is_IO_addr_addr < 64'h0000000080010000 ;

  // value method m_is_near_mem_IO_addr
  assign m_is_near_mem_IO_addr =
	     m_is_near_mem_IO_addr_addr >= 64'h0000000080000000 &&
	     m_is_near_mem_IO_addr_addr < 64'h0000000080010000 ;

  // value method m_pc_reset_value
  assign m_pc_reset_value = 64'h0 ;
endmodule  // mkSoC_Map
