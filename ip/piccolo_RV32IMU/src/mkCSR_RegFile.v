...
//
// On Thu Mar  7 13:50:33 PST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkCSR_RegFile(CLK,
  ...
  wire [31 : 0] IF_csr_ret_actions_from_priv_EQ_0b11_010_THEN__ETC___d1031,
		_theResult___fst__h7767,
		_theResult___fst__h7968,
		...
		y__h7801,
		y__h7818;
  wire [22 : 0] fixed_up_val_23__h3735,
		fixed_up_val_23__h6113,
		fixed_up_val_23__h7686;
  wire [5 : 0] ie_from_x__h7751, pie_from_x__h7752;
  ...
  wire [1 : 0] mpp__h6873, to_y__h7967;
  ...
  // actionvalue method csr_trap_actions
  assign csr_trap_actions = { x__h5486, x__h7611, x__h7621, 2'b11 } ;
  ...
  assign MUX_rw_minstret$wset_1__VAL_1 =
	     (mav_csr_write_csr_addr == 12'hB02) ? x__h4827 : x__h4935 ;
  ...
  // submodule csr_mie
  assign csr_mie$fav_write_misa = 28'd68161792 ;
  ...
  assign csr_mip$external_interrupt_req_req =
	     external_interrupt_req_set_not_clear ;
  assign csr_mip$fav_write_misa = 28'd68161792 ;
  ...
  assign IF_csr_ret_actions_from_priv_EQ_0b11_010_THEN__ETC___d1049 =
		 ...
		 _theResult___fst__h7767 } :
	       { to_y__h7967, _theResult___fst__h7968 } ;
  ...
  assign _theResult___fst__h7767 =
  ...
  assign _theResult___fst__h7968 =
  ...
  assign csr_mstatus_rg_mstatus_70_AND_INV_1_SL_0_CONCA_ETC___d1024 =
	     x__h7800 | mask__h7788 ;
  assign exc_pc___1__h6833 = exc_pc__h6674 + vector_offset__h6782 ;
  assign exc_pc__h6674 = { rg_mtvec[30:1], 2'd0 } ;
  assign fixed_up_val_23__h3735 =
  ...
  assign fixed_up_val_23__h7686 =
		...
		2'b11) ?
		 ...
		 2'b0,
	       ...
	       2'd0 } ;
  assign ie_from_x__h7751 = { 4'd0, csr_ret_actions_from_priv } ;
  assign mask__h7788 = 32'd1 << pie_from_x__h7752 ;
  assign mask__h7805 = 32'd1 << ie_from_x__h7751 ;
  ...
  assign mpp__h6873 =
	     (csr_trap_actions_from_priv == 2'b11) ?
	       csr_trap_actions_from_priv :
	       2'b0 ;
  assign pie_from_x__h7752 = { 4'd1, csr_ret_actions_from_priv } ;
  assign to_y__h7967 =
	     { 1'b0,
	       csr_mstatus_rg_mstatus_70_AND_INV_1_SL_0_CONCA_ETC___d1024[8] } ;
  assign v__h4177 =
	     { mav_csr_write_word[31:2], 1'b0, mav_csr_write_word[0] } ;
  assign v__h4239 = { 29'd0, mav_csr_write_word[2:0] } ;
  assign v__h4395 =
	     { mav_csr_write_word[31], 27'd0, mav_csr_write_word[3:0] } ;
  assign val__h7806 = { 31'd0, b__h7804 } << ie_from_x__h7751 ;
  assign vector_offset__h6782 = { 26'd0, csr_trap_actions_exc_code, 2'd0 } ;
  assign wordxl1__h3694 = { 9'd0, fixed_up_val_23__h3735 } ;
  assign x__h4827 = { rg_minstret[63:32], mav_csr_write_word } ;
  assign x__h4935 = { mav_csr_write_word, rg_minstret[31:0] } ;
  assign x__h5486 =
	     (csr_trap_actions_interrupt && rg_mtvec[0]) ?
	       exc_pc___1__h6833 :
	       exc_pc__h6674 ;
  assign x__h7611 = { 9'd0, fixed_up_val_23__h6113 } ;
  assign x__h7621 =
	     { csr_trap_actions_interrupt,
	       27'd0,
	       csr_trap_actions_exc_code } ;
  assign x__h7787 = x__h7817 | val__h7806 ;
  assign x__h7800 = x__h7787 & y__h7801 ;
  assign x__h7817 = csr_mstatus_rg_mstatus & y__h7818 ;
  assign y__h7801 = ~mask__h7788 ;
  assign y__h7818 = ~mask__h7805 ;
  ...
  always@(mav_csr_write_csr_addr or
	  ...
	  v__h4177 or
	  v__h4239 or mav_csr_write_word or v__h4395 or csr_mip$fav_write)
  begin
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__19_ULE_1_20___d721)
	$write("    Return: new pc 0x%0h  ", x__h5486);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__19_ULE_1_20___d721)
	$write(" new mstatus:");
    if (RST_N != `BSV_RESET_VALUE)
